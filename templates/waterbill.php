...
<html lang="en">
    ...
    <body style="background-image: url('../img/waterbill.jpeg');">
        ...
        <div class="container" style="height: 520px; top: 2%">
            <form method='post' class="login-box" style="gap: 2%;">
                <H2>Bill Details</H2>
                ...
                if($_SESSION['admin'] != TRUE){
                    ...
                    try{
                        ...
                        $sql = "SELECT * from water where aadharno = '$aadhar' order by id desc";
                    ...
                    if(array_key_exists('payment', $_POST)){
                        try{
                            ...
                            $sql = "UPDATE water SET paid = TRUE where houseno = '$house' and State_ = '$state' and month_ = '$month'";
                            mysqli_query($conn, $sql);
                            $sql = "UPDATE water SET paymentdate = CURDATE() where houseno = '$house' and State_ = '$state' and month_ = '$month'";
                            mysqli_query($conn, $sql);
                    ...
                    if(array_key_exists('payment', $_POST)){
                        ...
                        try{
                            ...
                            $sql = "INSERT INTO water(aadharno, houseno, State_, amount, month_, billdate, paid) VALUES ('$aadhar', '$house', '$state', '$amount', '$month', CURDATE(), 'FALSE')";
                ...
                <input type="text" name="house" class="email ele" placeholder="House no" required>
