...
<html lang="en">
    ...
    <body style="background-image: url('../img/phonebill.jpeg'); background-repeat: no-repeat; background-size: cover;">
            ...
            <form method="POST" class="login-box" style="gap: 3%;">
                ...
                if($_SESSION['admin'] != TRUE){
                    ...
                    try{
                        ...
                        $sql = "SELECT * from phone where aadharno = '$aadhar' order by id desc";
                    ...
                    if(array_key_exists('payment', $_POST)){
                        try{
                            ...
                            $sql = "UPDATE phone SET paid = TRUE where phone_no = '$phone' and operatorName = '$operator' and month_ = '$month'";
                            mysqli_query($conn, $sql);
                            $sql = "UPDATE phone SET paymentdate = CURDATE() where phone_no = '$phone' and operatorName = '$operator' and month_ = '$month'";
                            mysqli_query($conn, $sql);
                            $flag = TRUE;
                        }catch(exception $e){
                            echo $sql . "<br>" . $e->getMessage();
                    ...
                    if(array_key_exists('payment', $_POST)){
                        ...
                        try{
                            ...
                            $sql = "INSERT INTO phone(aadharno, operatorName, phone_no, amount, month_, billdate, paid) VALUES ('$aadhar', '$operator', '$phone', '$amount', '$month', CURDATE(), 'FALSE')";
                ...
                <input type="text" name="operator" class="email ele" placeholder="Operator Name" required>
                <input type="text" name="phone" class="email ele" placeholder="Phone Number" required>
